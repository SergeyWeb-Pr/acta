...
const mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.mySwiper', {
  slidesPerView: 'auto',
  navigation: {
...
const Swipersingle = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.Swipersingle', {
  slidesPerView: 'auto',
  navigation: {
    nextEl: ".swiper-button-next",
    prevEl: ".swiper-button-prev"
...
const Swipernews = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.swipernews', {
  slidesPerView: 'auto',
  pagination: {
    el: ".swiper-pagination",
    clickable: true
...
const scroll = new (smooth_scroll__WEBPACK_IMPORTED_MODULE_4___default())('a[href*="#"]'); // Подключение событий свайпа на мобильных
