...
const block_review__swiper = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.block_review__swiper', {
  slidesPerView: 4,
  spaceBetween: 10,
  loop: true,
  navigation: {
...
const block_trust__swiper = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.block_trust__swiper', {
  slidesPerView: 4,
  spaceBetween: 10,
  loop: true,
  navigation: {
...
const block_service__swiper = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.block_service__swiper', {
  slidesPerView: 4,
  spaceBetween: 10,
  loop: true,
  navigation: {
...
$(function () {
  $(".accordion2").accordion({
    header: ".block_faq__item_name",
    collapsible: true,
    active: true
  });
});

//Доработка аккордеона
$('.repair__item').click(function () {
  if ($(this).children('.ui-accordion-header').hasClass('accordion-header-active')) {
    $(this).children('.repair__item_link').addClass('active');
    $(this).addClass('active');
  } else {
    $(this).children('.repair__item_link').removeClass('active');
    $(this).removeClass('active');
  }
});

//Удаление уведомления о времени работы
$('.block_notification__close').on('click', function () {
  $('.block_notification').css("display", "none");
});
$(".nav__item").hover(function () {
  if ($(this).children('.nav__two').hasClass('block')) {
    $(this).children('.nav__two').removeClass("block");
  } else {
    $(this).children('.nav__two').addClass("block");
  }
});
