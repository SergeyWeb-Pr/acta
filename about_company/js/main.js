...
$(document).ready(function () {
  $(function () {
    $(".benefits__item1").hover(onIn1, onOut1);
  });

  function onIn1() {
    $('.benefits__count1').addClass('shake');
  }

  function onOut1() {
    $('.benefits__count1').removeClass('shake');
  } //


  $(function () {
    $(".benefits__item2").hover(onIn2, onOut2);
  });

  function onIn2() {
    $('.benefits__count2').addClass('shake');
  }

  function onOut2() {
    $('.benefits__count2').removeClass('shake');
  } //


  $(function () {
    $(".benefits__item3").hover(onIn3, onOut3);
  });

  function onIn3() {
    $('.benefits__count3').addClass('shake');
  }

  function onOut3() {
    $('.benefits__count3').removeClass('shake');
  } //


  $(function () {
    $(".benefits__item4").hover(onIn4, onOut4);
  });

  function onIn4() {
    $('.benefits__count4').addClass('shake');
  }

  function onOut4() {
    $('.benefits__count4').removeClass('shake');
  } //


  $(function () {
    $(".benefits__item5").hover(onIn5, onOut5);
  });

  function onIn5() {
    $('.benefits__count5').addClass('shake');
  }

  function onOut5() {
    $('.benefits__count5').removeClass('shake');
  }
}); //Добавление строк в таблицу по нажатию

(function () {
  var _document, _document2;

  const tablebutton = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelector('.table__button');
  const tableitem = (_document2 = document) === null || _document2 === void 0 ? void 0 : _document2.querySelectorAll('.table__item');
  tablebutton === null || tablebutton === void 0 ? void 0 : tablebutton.addEventListener('click', e => {
    for (var i = 0; i < tableitem.length; i++) {
      let k = i;
      tableitem[k].classList.add('table__active');
    }

    tablebutton.classList.add('table__hide');
  });
})(); // Accordion
...
const mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.mySwiper', {
  slidesPerView: 'auto',
  navigation: {
...
const Swipersingle = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.Swipersingle', {
  slidesPerView: 'auto',
  navigation: {
    nextEl: ".swiper-button-next",
    prevEl: ".swiper-button-prev"
...
const Swipernews = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.swipernews', {
  slidesPerView: 'auto',
  pagination: {
    el: ".swiper-pagination",
    clickable: true
...
(function () {
  var _document, _document2, _document3, _document4, _document5, _document6, _document7, _document8, _document9, _document10;
  ...
  const header = (_document5 = document) === null || _document5 === void 0 ? void 0 : _document5.querySelector('.header');
  const graphmodal = (_document6 = document) === null || _document6 === void 0 ? void 0 : _document6.querySelector('.graph-modal');
  const buttonclick = (_document7 = document) === null || _document7 === void 0 ? void 0 : _document7.querySelector('.button__click');
  const pagebody = (_document8 = document) === null || _document8 === void 0 ? void 0 : _document8.querySelector('.page__body');
  const modalcontainer = (_document9 = document) === null || _document9 === void 0 ? void 0 : _document9.querySelector('.graph-modal__container');
  const modalclose = (_document10 = document) === null || _document10 === void 0 ? void 0 : _document10.querySelector('.graph-modal__close');
  burger === null || burger === void 0 ? void 0 : burger.addEventListener('click', e => {
    ...
    header === null || header === void 0 ? void 0 : header.classList.toggle('menu--active2');
  ...
  graphmodal === null || graphmodal === void 0 ? void 0 : graphmodal.addEventListener('click', () => {
    ...
    if (modalcontainer !== null && modalcontainer !== void 0 && modalcontainer.classList.contains('graph-modal-open')) {
      burger === null || burger === void 0 ? void 0 : burger.classList.remove('burger--active');
    } else {
      modalcontainer === null || modalcontainer === void 0 ? void 0 : modalcontainer.classList.remove('graph-modal-open');
      graphmodal === null || graphmodal === void 0 ? void 0 : graphmodal.classList.remove('is-open');
    }
  });
